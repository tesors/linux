...
static u8 edid[] = {
    ...
    0x02, 0x03, 0x5A, 0x71, 0x5F, 0x61, 0x60, 0x5F,
    0x5E, 0x5D, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67,
    0x68, 0x69, 0x6A, 0x6B, 0x4A, 0x4B, 0x4C, 0x52,
    0x53, 0x59, 0x5A, 0x01, 0x02, 0x03, 0x04, 0x10,
    0x11, 0x12, 0x13, 0x1F, 0x4B, 0x20, 0x21, 0x44,
    0x45, 0x48, 0x49, 0x05, 0x06, 0x14, 0x15, 0x22,
    0x23, 0x0F, 0x07, 0x07, 0x83, 0xFF, 0x07, 0x00,
    0x6E, 0x03, 0x0C, 0x00, 0x10, 0x00, 0x38, 0x3C,
    0x2F, 0x00, 0x80, 0x01, 0x02, 0x03, 0x04, 0x67,
    0xD8, 0x5D, 0xC4, 0x01, 0x78, 0x80, 0x03, 0xE3,
    0x05, 0xE7, 0x01, 0xE2, 0x00, 0xEA, 0xE3, 0x0F,
    0xFF, 0x7F, 0x14, 0x69, 0x00, 0xA0, 0xA0, 0x40,
    0x2E, 0x60, 0x30, 0x20, 0x36, 0x00, 0x00, 0x00,
...
{
    int present = i2c_rd8(sd, AU_STATUS0) & MASK_S_A_SAMPLE;
    printk("audio_present %d \n", present);
...
static int get_audio_sampling_rate(struct v4l2_subdev *sd)
{
	...
	if (no_signal(sd))
		return 0;
    rate = code_to_rate[i2c_rd8(sd, FS_SET) & MASK_FS];
    printk("get_audio_sampling_rate %d \n", rate);
